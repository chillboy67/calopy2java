...
class TseWriter:
    ...
    def getHeader(self, buf: io.BytesIO):
        # return the string "TSE PhenoMaster V7.1.2 (2019-5479)" to buf
        buf.write(b"TSE PhenoMaster V7.1.2 (2019-5479) \n")
        buf.write(b"\n")
    ...
    def getMeasurementData(self, buf: io.BytesIO):
        ...
        for measurement in header:
            if measurement in self.caliData.units:
    ...
    def getCurrentSessionState(self, buf: io.BytesIO):
        ...
        buf.write(b"\n")
        self.writeLine(buf, "calopy TseState")
        self.writeLine(buf, "Filter:")
